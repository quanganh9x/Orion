            ...
            face.detect({
                ...
                for (let k = 0; k < response.length; k++) {
                    (async () => {
                        ...
                        draw.drawFaceText(img, vertices, 30, 10, 20, (k+1) + ": " + response[k].faceAttributes.age + ", " + response[k].faceAttributes.gender + ", " + Math.ceil(response[k].faceAttributes.smile * 100) + "%")
